#include <nvkg/Renderer/RenderPass/Utils/Attachments.hpp>
...
namespace nvkg {
    ...
    VkAttachmentReference Attachments::CreateAttachmentReference(uint32_t attachment, VkImageLayout imageLayout) {
    ...
    Attachments::CreateGraphicsSubpass(uint32_t colorAttachmentCount,
                                       const VkAttachmentReference *colorAttachments,
                                       const VkAttachmentReference *depthStencilAttachment,
                                       const VkAttachmentReference *resolveAttachments,
                                       uint32_t preserveAttachmentCount,
    ...
    VkSubpassDescription Attachments::SubPassBuilder::BuildGraphicsSubPass() {
        return CreateGraphicsSubpass(colorReferences.size(),
