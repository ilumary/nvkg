...
namespace nvkg
{
    ...
    void Camera::set_perspective_proj(float fovy, float aspect, float near, float far) {
        NVKG_ASSERT(glm::abs(aspect - std::numeric_limits<float>::epsilon()) > 0.0f, "");
    ...
    void Camera::set_view_dir(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
