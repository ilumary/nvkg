...
{
    glm::mat4 Math::calc_transform_3d(const glm::vec3& position, const glm::vec3& rotation, const glm::vec3& scale)
    {
    ...
    glm::mat3 Math::calc_normal_matrix(const glm::vec3& rotation, const glm::vec3& scale)
    {
        const float c3 = glm::cos(rotation.z);
        const float s3 = glm::sin(rotation.z);
        const float c2 = glm::cos(rotation.x);
